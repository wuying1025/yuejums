...
//        $order_col = array('1'=>'plot_id');
    ...
    public function add_plot(){
        ...
        $plot_description = $this->input->post('content');
...
//        echo $plot_id;die();
        $this->load->model('plot_model');
        $query=$this->plot_model->update_plot_name($plot_id,$plot_name,$deve,$plot_description,$plot_video,$plot_pos);
        if($query){
            redirect('plot');
        }
    }
